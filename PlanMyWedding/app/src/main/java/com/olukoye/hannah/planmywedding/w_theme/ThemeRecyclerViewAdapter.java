...
public class ThemeRecyclerViewAdapter extends RecyclerView.Adapter<ThemeRecyclerViewAdapter.ViewHolder> {
    ...
    public ThemeRecyclerViewAdapter(Context context, List<ImageUploadInfo> TempList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.theme_recyclerview_item_layout, parent, false);
